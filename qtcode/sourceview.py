...
#        self.pushButton_5.setAutoFillBackground(True)
        ...
        self.treeView.setRootIndex(self.model.setRootPath(self.__currentpath))
    ...
    def _run_script(self):
        self.cexec(self.plainTextEdit.toPlainText(), isfile = True)

    def cexec(self, arg1, isfile = False):
